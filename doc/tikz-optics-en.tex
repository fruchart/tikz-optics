...
% Environnement |example only| : similar appearance to codeexample, but with only the example (when the code is too long)
...
\begin{itemize}
  ...
  \item By directly including the file |tikzlibraryoptics.code.tex| containing the library with the |\input| command.
\end{itemize}
