#!/bin/bash    
# Script to create a CTAN package for tikz-optics.
...
if [ -f "tikz-optics.tds.zip" ]; then
	...
	echo -e "\e[1m\e[91mWarning:\e[39m\e[21m no tikz-optics.tds.zip file found so it will not be included; use build_tds.sh to create/update it."
fi
